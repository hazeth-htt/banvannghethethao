export const SITE_CONFIG = {
  ...
  subName: "Đoàn Thanh niên Đại học Bách khoa Hà Nội",
  shortName: "BVNTT HUST",
  description: "Ban Văn nghệ Thể thao - Đoàn Thanh niên Đại học Bách khoa Hà Nội. Nơi khơi nguồn đam mê, thắp sáng tài năng và lưu giữ những khoảnh khắc thanh xuân rực rỡ nhất dưới mái trường Bách khoa.",
